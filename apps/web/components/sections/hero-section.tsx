...
const sideImages = [
  {
    ...
    alt: "Coworking exterior with premium workspace design",
    position: "left",
    span: 1,
  },
  {
    src: "/images/hero-side-2.png",
    alt: "Coworking neighborhood with flexible office access",
    position: "left",
    span: 1,
  },
  {
    src: "/images/hero-side-3.png",
    alt: "Quiet workspace with natural light",
    position: "right",
    span: 1,
  },
  {
    src: "/images/hero-side-4.png",
    alt: "Private offices and desks available after hours",
    position: "right",
    span: 1,
  },
];
    ...
    <section id="hero" ref={sectionRef} className="relative bg-background">
          ...
          >
            ...
            >
              ...
              <Image
                ...
                alt="Premium coworking building exterior"
                fill
      ...
      >
        <p className="mx-auto max-w-2xl text-center text-2xl leading-relaxed text-white md:text-3xl lg:text-[2.5rem] lg:leading-snug">
          Flexible desks, private offices,
          <br />
          and meeting rooms that work on your schedule.
        </p>
      </div>
