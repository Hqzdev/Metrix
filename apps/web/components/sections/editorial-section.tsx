...
const specs = [
  { label: "Desk Access", value: "24/7" },
  { label: "Meeting Rooms", value: "12" },
  { label: "Average Check-in", value: "2 min" },
  { label: "Wi-Fi", value: "1 Gbps" },
];
...
export function EditorialSection() {
  ...
  return (
    <section className="bg-background">
      ...
      {/* Decorative Icons */}
      <div className="flex items-center justify-center gap-6 pb-36">
      ...
      <div className="grid grid-cols-2 border-t border-border md:grid-cols-4">
        {specs.map((spec) => (
          <div
            key={spec.label}
            className="border-b border-r border-border p-12 text-center last:border-r-0 md:border-b-0 md:p-16"
          >
