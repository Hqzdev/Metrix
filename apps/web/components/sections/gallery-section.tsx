...
export function GallerySection() {
  ...
  const images = [
    { src: "/images/mono-1.png", alt: "Coworking entrance in the morning" },
    { src: "/images/mono-2.png", alt: "Shared desk area during peak hours" },
    { src: "/images/mono-3.png", alt: "Private office floor in the afternoon" },
    { src: "/images/mono-4.png", alt: "Meeting room lighting in the evening" },
  ];
