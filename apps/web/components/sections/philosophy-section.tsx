      ...
      <div ref={descriptionRef} className="px-6 pt-8 pb-20 md:px-12 md:pt-12 md:pb-28 lg:px-20 lg:pt-16 lg:pb-36">
        <div className="text-center">
          ...
          <p className="mt-8 leading-relaxed text-muted-foreground text-3xl text-center">
            {("Metrix brings premium coworking into a booking experience that feels immediate and calm. Reserve a desk for a focused day, move into a private office for deep work, or lock a meeting room for the hour you actually need.").split(" ").map((word, index, array) => {
