...
Этот документ описывает блок apps/telegram-bot/src/integrations/calendar: авторизацию календарей, хранение токенов, создание событий, удаление событий и синхронизацию занятости.
