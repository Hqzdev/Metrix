...
- Изменение схемы и миграции коммитятся вместе.
- Seed-данные коммитятся отдельно, если не нужны для миграции.
- После изменения schema.prisma нужно запускать prisma:validate.
- Нельзя коммитить дампы базы или реальные персональные данные.
