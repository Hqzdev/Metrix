...
const resources = [
  ...
  resource('r2', 'patriarchy', 'Founder Office', 'office', '6 seats', '4 of 6 occupied', '$14,600 / month', 'Available now'),
  resource('r3', 'patriarchy', 'Garden Meeting Suite', 'room', '8 seats', 'Booked 58% this week', '$320 / hour', 'Open after 2 PM'),
  ...
  resource('r7', 'belorusskaya', 'Transit Office', 'office', '4 seats', '2 of 4 occupied', '$10,800 / month', 'Available tomorrow'),
  resource('r8', 'belorusskaya', 'Rail Meeting Room', 'room', '12 seats', 'Booked 49% this week', '$270 / hour', 'Open after 5 PM'),
  ...
  resource('r12', 'paveletskaya', 'Bridge Office', 'office', '5 seats', '4 of 5 occupied', '$13,900 / month', 'One seat opens Friday'),
  resource('r13', 'paveletskaya', 'Investor Room', 'room', '10 seats', 'Booked 63% this week', '$310 / hour', 'Limited availability'),
